...
In the completed version the keyboard keys light up, color coded for fingers, and as they are pressed the next key will will light up. When the wrong key is pressed, it will turn red to inicate an error.
